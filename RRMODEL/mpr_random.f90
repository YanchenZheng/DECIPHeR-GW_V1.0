...
!! This module contains subroutines for random generation of parameter values.
!
!   get_BasPred_LnTo    Complete logical list of basin predictors required for LnTo
!
!
!! Rosie Lane - 6th November 2017
...
!        return
!    end
    subroutine i4_uniform_ab ( a, b, seed ,i4_uniform_ab_value)
        ...
        integer ( kind = 4 ) b
        integer ( kind = 4 ), parameter :: i4_huge = 2147483647
        integer ( kind = 4 ) i4_uniform_ab_value
        integer ( kind = 4 ) k
        real ( kind = 4 ) r
        integer ( kind = 4 ) seed
        ...
        do count = n-1, 2, -1
            ...
            do i = 1, dim_num
                ...
                do k = count*duplication, 1, -1
                    call i4_uniform_ab ( 1, k, seed  ,point_index)
